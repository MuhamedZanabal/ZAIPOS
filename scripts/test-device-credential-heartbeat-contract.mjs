...
assert.match(sql, /length\(p_device_credential\)\s*<>\s*64/i);
assert.match(sql, /credential_hash\s*=\s*extensions\.digest\(convert_to\(p_device_credential, 'UTF8'\), 'sha256'\)/i);
