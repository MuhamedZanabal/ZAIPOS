...
function phase(name) {
  currentPhase = name;
  process.stdout.write(`INVENTORY_LOT_RUNTIME_PHASE=${name}\n`);
}
...
phase("second-receipt-and-aggregate");
...
phase("expired-stock-and-rollback");
...
phase("generic-inbound-fail-closed");
