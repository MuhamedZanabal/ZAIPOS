...
describe('native manager authority',()=>{
 beforeEach(()=>{mocks.handlers.clear();vi.unstubAllGlobals();vi.stubEnv('VITE_SUPABASE_URL','https://contract.supabase.co');vi.stubEnv('VITE_SUPABASE_PUBLISHABLE_KEY','public-contract-key');});
