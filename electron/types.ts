...
export const DEFAULT_SETTINGS: AppSettings = {
  kiosk: false, updateChannel: 'stable',
  printer: { connectionType: 'usb', devicePath: process.platform === 'win32' ? '\\\\.\\COM1' : '/dev/usb/lp0', width: 42, characterSet: 'SLOVENIA' },
  barcode: { mode: 'hid', baudRate: 9600 },
};
